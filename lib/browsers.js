...
exports.edgechromium = {
  bin: 'msedge.exe',

  find: function() {
    this.dir('LOCALAPPDATA', 'Microsoft\\Edge Beta\\Application')
    this.dir('LOCALAPPDATA', 'Microsoft\\Edge Dev\\Application')
    this.dir('LOCALAPPDATA', 'Microsoft\\Edge\\Application')
    this.registry('EdgeUpdate', 'InstallerSuccessLaunchCmdLine')
